...
<table id="config_state_startfk">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <label{style_branch}>{startfk_branch}</label>
            </td>
            <td>
        ...
        with gr.Tabs(elem_id="tabs_extensions"):
            ...
            with gr.TabItem("Available", id="available"):
                with gr.Row():
                    ...
                    extensions_index_url = os.environ.get('STARTFK_EXTENSIONS_INDEX', "https://raw.githubusercontent.com/zetclansu/lite-kaggle-assets/main/extensions.json")
