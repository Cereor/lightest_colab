...
sd_repo_configs_path = os.path.join(paths.paths['Ztable Bibusion'], "configs", "ztable_bibusion")
sd_xl_repo_configs_path = os.path.join(paths.paths['Ztable Bibusion XL'], "configs", "inference")
