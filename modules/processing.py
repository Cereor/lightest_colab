...
class ZtableBibusionProcessing:
    ...
    def __post_init__(self):
        if self.sampler_index is not None:
            print("sampler_index argument for ZtableBibusionProcessing does not do anything; use sampler_name", file=sys.stderr)
        ...
        self.cached_uc = ZtableBibusionProcessing.cached_uc
        self.cached_c = ZtableBibusionProcessing.cached_c
    ...
    def close(self):
        ...
        if not opts.persistent_cond_cache:
            ZtableBibusionProcessing.cached_c = [None, None]
            ZtableBibusionProcessing.cached_uc = [None, None]
...
class Processed:
    def __init__(self, p: ZtableBibusionProcessing, images_list, seed=-1, info="", subseed=None, all_prompts=None, all_negative_prompts=None, all_seeds=None, all_subseeds=None, index_of_first_image=0, infotexts=None, comments=""):
    ...
    def infotext(self, p: ZtableBibusionProcessing, index):
...
def process_images(p: ZtableBibusionProcessing) -> Processed:
    ...
    try:
        ...
        # and if after running refiner, the refiner model is not unloaded - startfk swaps back to main model here, if model over is present it will be reloaded afterwards
...
def process_images_inner(p: ZtableBibusionProcessing) -> Processed:
...
@dataclass(repr=False)
class ZtableBibusionProcessingTxt2Img(ZtableBibusionProcessing):
    ...
    def __post_init__(self):
        ...
        self.cached_hr_uc = ZtableBibusionProcessingTxt2Img.cached_hr_uc
        self.cached_hr_c = ZtableBibusionProcessingTxt2Img.cached_hr_c
    ...
    def close(self):
        ...
        self.hr_uc = None
        if not opts.persistent_cond_cache:
            ZtableBibusionProcessingTxt2Img.cached_hr_uc = [None, None]
            ZtableBibusionProcessingTxt2Img.cached_hr_c = [None, None]
...
@dataclass(repr=False)
class ZtableBibusionProcessingImg2Img(ZtableBibusionProcessing):
