...
options_templates.update(options_section(('saving-images', "Saving images/grids"), {
    ...
    "save_incomplete_images": OptionInfo(False, "Save incomplete images").info("save images that has been interrupted in mid-generation; even if not saved, they will still show up in startfk output."),
}))
...
options_templates.update(options_section(('system', "System"), {
    "auto_launch_browser": OptionInfo("Local", "Automatically open startfk in browser on startup", gr.Radio, lambda: {"choices": ["Disable", "Local", "Remote"]}),
